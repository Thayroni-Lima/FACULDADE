...
#Saída
print(f"Considerando altura de {altura} m, largura de {largura} m e profundidade de {profundidade} m, a capacidade da sua caixa d'água ({capacidade_m3}) m³ em litros é {capacidade_litros:,.2f} L.")
